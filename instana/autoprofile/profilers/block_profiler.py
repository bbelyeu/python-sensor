...
class BlockProfiler(object):
    ...
    def setup(self):
        if self.apagent.get_option('block_profiler_disabled'):
            return
    ...
    def start_profiler(self):
        self.apagent.log('AutoProfile Activating block profiler.')
    ...
    def stop_profiler(self):
        ...
        self.apagent.log('AutoProfile Deactivating block profiler.')
